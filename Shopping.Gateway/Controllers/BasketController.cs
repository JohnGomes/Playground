...
namespace Shopping.Gateway.Controllers
{
    ...
    public class BasketController : ControllerBase
    {
        ...
        public async Task<ActionResult<BasketData>> UpdateAllBasketAsync([FromBody] UpdateBasketRequest data)
        {
            ...
            var catalogItems = await _catalogGrpc.GetCatalogItemsAsync(data.Items.Select(x => x.ProductId));
        ...
        public async Task<ActionResult> AddBasketItemAsync([FromBody] AddBasketItemRequest data)
        {
            ...
            var item = await _catalogGrpc.GetCatalogItemAsync(data.CatalogItemId);
