...
using CatalogBrand = GrpcCatalog.CatalogBrand;
using CatalogType = GrpcCatalog.CatalogType;
...
namespace Catalog.Api.Grpc
{
     public class CatalogGrpcService : GrpcCatalog.Catalog.CatalogBase
     {
          ...
          public CatalogGrpcService(CatalogContext dbContext, IOptions<CatalogSettings> settings, ILogger<CatalogGrpcService> logger)
          {
          ...
          public override Task<HelloReply> SayHello(HelloRequest request, ServerCallContext context)
          {
              ...
              {
                  Message = "Hello " + request.Name + " From Catalog Api"
              });
          }
